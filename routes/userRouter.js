...
//router.get('/aditya', userController.getStatus)
router.post('/v2/user', userController.addUser)
router.get('/v2/user/:id', userController.getUser)
router.put('/v2/user/:id', userController.updateUser)
